 ...
 * This exception is thrown when a new wheel is trying to be added in an arraylist that has already the maximum allowed wheel count.
...
public class TooManyWheelsException extends Exception {
	 ...
	 */
	public TooManyWheelsException(String msg) {
		super(msg);
		this.msg = msg;
	}
