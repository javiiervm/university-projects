...
public class Algorithms {
	 ...
	 */
	public static <NodeLabelType, EdgeLabelType extends Comparable<EdgeLabelType>> List<Node<NodeLabelType>> dfs(Graph<NodeLabelType, EdgeLabelType> graph, Node<NodeLabelType> fromNode) {
	 ...
	 */
	public static <NodeLabelType, EdgeLabelType extends Comparable<EdgeLabelType>> EdgeLabelType shortestPathCost(Graph<NodeLabelType, EdgeLabelType> graph, Node<NodeLabelType> fromNode, Node<NodeLabelType> toNode, ICostOperators<EdgeLabelType> cost) throws NodeNotFoundException, GraphAlgorithmException {
		DijkstraShortestPath<NodeLabelType, EdgeLabelType> dijkstraShortestPath = new DijkstraShortestPath<NodeLabelType, EdgeLabelType>(graph, cost);
		...
		EdgeLabelType distance = (EdgeLabelType) dijkstraShortestPath.getComputedDistances().get(toNode);
		if (distance == null) {
	 ...
	 */
	public static <NodeLabelType, EdgeLabelType extends Comparable<EdgeLabelType>> void exportDot(File file, Graph<NodeLabelType, EdgeLabelType> graph) throws FileNotFoundException {
