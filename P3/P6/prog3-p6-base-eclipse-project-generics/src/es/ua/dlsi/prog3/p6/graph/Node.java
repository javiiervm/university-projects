 ...
 * @author drizo
 */
public class Node<LabelType> extends GraphObject<LabelType> {
	/**
	 ...
	 */	
	public Node(Node<LabelType> node) {
		super(node);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Node<LabelType> other = (Node<LabelType>) obj;
		if (label == null) {
			if (other.label != null)
				return false;
