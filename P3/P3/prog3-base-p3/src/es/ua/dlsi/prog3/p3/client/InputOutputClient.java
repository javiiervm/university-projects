...
class MouseTracker implements Runnable {
	...
	/**
	 * Instance attribute.
	 * It defines a mouse object from class mouse.
	 * It is used to manage a mouse.
	 */
	Mouse mouse;
	
	/**
	 * Instance attribute.
	 * It defines a display object from class display.
	 * It is used to manage a display.
	 */
	Display display;
	
	/**
	 * Instance attribute.
	 * It defines the number of lines that are printed.
	 */
	int linesPrinted;
